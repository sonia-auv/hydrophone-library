-- -------------------------------------------------------------
-- 
-- File Name: hydro_inverted_matrix\hdlsrc\Test_DOA\Division.vhd
...
ARCHITECTURE rtl OF Division IS
  ...
  SIGNAL Delay_out1_bypass                : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_out1_last_value            : unsigned(7 DOWNTO 0);  -- uint8
...
BEGIN
  ...
  Data_Type_Conversion1_out1 <= unsigned(Divide_out1(15 DOWNTO 8));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_out1_last_value <= to_unsigned(16#00#, 8);
      ELSIF enb_gated = '1' THEN
