-- -------------------------------------------------------------
-- 
-- File Name: phase-out\hdlsrc\Test_DOA\Calcul_Direction.vhd
...
ARCHITECTURE rtl OF Calcul_Direction IS
  ...
  SIGNAL Data_Type_Conversion8_out1       : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Delay3_out1                      : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Delay3_out1_bypass               : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Delay3_out1_last_value           : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  Data_Type_Conversion8_out1 <= IndexIn_unsigned(9 DOWNTO 0);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_gated = '1' THEN
        Delay3_out1 <= Data_Type_Conversion8_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_out1_last_value <= to_unsigned(16#000#, 10);
      ELSIF enb_gated = '1' THEN
