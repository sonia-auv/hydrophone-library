-- -------------------------------------------------------------
-- 
-- File Name: phase-out\hdlsrc\Test_DOA\Test_DOA.vhd
...
ENTITY Test_DOA IS
  PORT( clk                               :   IN    std_logic;
        ...
        Index                             :   OUT   std_logic_vector(9 DOWNTO 0);  -- ufix10
...
ARCHITECTURE rtl OF Test_DOA IS
  ...
  SIGNAL Calcul_Direction_out1            : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL Calcul_Direction_out2            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Calcul_Direction_out3            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Calcul_Direction_out4            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Calcul_Direction_out5            : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_Calcul_Direction : Calcul_Direction
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              IndexIn => Maximum_Hydro_Ref_out4,  -- ufix17
              PhaseRefIn => Maximum_Hydro_Ref_out2,  -- sfix20_En17
              Phase1In => Maximum_Hydro_1_out2,  -- sfix20_En17
              Phase2In => Maximum_Hydro_2_out2,  -- sfix20_En17
              Phase3In => Maximum_Hydro_3_out2,  -- sfix20_En17
              Trigger => SNR_Check_out1,
              Index => Calcul_Direction_out1,  -- ufix10
              PhaseRef => Calcul_Direction_out2,  -- sfix32_En19
              Phase1 => Calcul_Direction_out3,  -- sfix32_En19
              Phase2 => Calcul_Direction_out4,  -- sfix32_En19
              Phase3 => Calcul_Direction_out5  -- sfix32_En19
              );
  ...
  Index <= Calcul_Direction_out1;

  Phase1 <= Calcul_Direction_out3;

  PhaseRef <= Calcul_Direction_out2;

  Phase2 <= Calcul_Direction_out4;

  Phase3 <= Calcul_Direction_out5;
